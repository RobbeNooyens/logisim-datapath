...
('ori'  , pattern((('op', 'ori'),  ('rd', register()), ('imm', integerpattern())), can_have_label=True),                            "ori rs imm     -->  rd := rd | imm",               lambda m, params : '1100'+str(reg2bin(m.group('rd'),REGISTER_ADDRESS_SIZE))+str(int2bin(m.group('imm'),8)) ),
...
('lui'  , pattern((('op', 'lui'),  ('rd', register()), ('imm', integerpattern())), can_have_label=True),                            "lui rs imm     -->  rd := imm << 6",               lambda m, params : '1101'+str(reg2bin(m.group('rd'),REGISTER_ADDRESS_SIZE))+str(int2bin(m.group('imm'),6)) ),
...
('j'    , pattern((('op', 'j'),    ('to', labelpattern())), can_have_label=True),                                                   "j addr          -->  pc := addr",                  lambda m, params : '1111'+str(label2bin(m.group('to'),8,params[1]))+'0100' ),
